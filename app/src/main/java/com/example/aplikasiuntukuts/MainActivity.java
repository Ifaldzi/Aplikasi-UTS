...
public class MainActivity extends AppCompatActivity {
    ...
    private static class CheeseAdapter extends RecyclerView.Adapter<CheeseAdapter.ViewHolder> {
        ...
        @Override
        public void onBindViewHolder(@NonNull MainActivity.CheeseAdapter.ViewHolder holder,
                                     int position) {
            mCursor.moveToPosition(position);
            holder.mText.setText(mCursor.getString(mCursor.getColumnIndex(Cheese.COLUMN_NAME)));
        }
